...
class FollowWall:
	...
	# 	#Need to change the topic used to command the robot to move based on what you defined in your urdf file.
        self.pub_vel = rospy.Publisher('/Bot2020141440041/cmd_vel', Twist, queue_size=1)
		
		#Need to change the topic used for publishing the laser data based on what you defined in your urdf file.
        self.sub_laser = rospy.Subscriber('/2020141440041Bot/laser/scan', LaserScan, self.callback_laser)
...
def HandleFollowWall(req):
      FollowWall(req.data)

if __name__=='__main__':
    rospy.init_node('follow_wall')
    rospy.Service('followWall_switch',SetBool,HandleFollowWall)
    print("Ready  to follow wall")
    rospy.spin()
