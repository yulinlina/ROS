...
class GoToPoint:
    ...
    def __init__(self,req=False):
        ...
        self.pub_vel = rospy.Publisher('Bot2020141440041/cmd_vel', Twist, queue_size=10)
		
		#Need to change the /odom topic based on what you defined in your urdf file.   
        self.sub_odom = rospy.Subscriber('Bot2020141440041/odom', Odometry, self.callback_odom)
...
def HandleGoToPoint(req):
    print("**********************Go to point handle is activated************************")
    GoToPoint(req.data)
    # return True,"My Bot reaches the goal"

if __name__ == '__main__':

    rospy.init_node('go_to_point')
    rospy.Service('GoToPoint_switch',SetBool,HandleGoToPoint)
    print("Ready  to go to point")
